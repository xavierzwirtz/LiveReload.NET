...
let website = "/LiveReload.NET"

let githubLink = "http://github.com/VoiceOfWisdom/LiveReload.NET"

// Specify more information about your project
let info =
  [ "project-name", "LiveReload.NET"
    "project-author", "Xavier Zwirtz"
    "project-summary", "Implements a LiveReload server for .NET"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/LiveReload.NET" ]
